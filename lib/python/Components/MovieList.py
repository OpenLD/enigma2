...
from enigma import eListboxPythonMultiContent, eListbox, gFont, iServiceInformation, eSize, \
...
MOVIE_EXTENSIONS = frozenset((".mpg", ".mpeg",".vob", ".m4v", ".mkv", ".avi", ".divx", ".dat", ".flv", ".mp4", ".mov", ".wmv", ".asf", ".webm", ".3gp", ".3g2", ".mpe", ".rm", ".rmvb", ".ogm", ".ogv", ".m2ts", ".mts", ".webm"))
