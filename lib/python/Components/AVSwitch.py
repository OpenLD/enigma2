...
class AVSwitch:
	...
	elif (about.getChipSetString() in ('7252', '7251', '7251S', '7252S', '72604', '7278', '7444S', '7251s', '7252s', '7444s', '3798mv200', '3798cv200', 'hi3798mv200', 'hi3798cv200')):
		modes["HDMI"] = ["720p", "1080p", "2160i", "2160p", "2160p30", "1080i", "576p", "576i", "480p", "480i"]
		widescreen_modes = {"720p", "1080p", "1080i", "2160i", "2160p", "2160p30"}
	elif (about.getChipSetString() in ('7111', '7162', '7241', '7346', '7356', '7358', '7362', '73565', '73625', '7424', '7425', '7435', '7552', '7581', '7584', '75845', '7585', 'pnx8493', '3716mv410', 'hi3716mv410')) or (getBrandOEM() in ('azbox')):
