...
def InitAVSwitch():
	...
	config.av.osd_alpha = ConfigSlider(default=255, limits=(0,255)) # Make openLD compatible with some plugins who still use config.av.osd_alpha
