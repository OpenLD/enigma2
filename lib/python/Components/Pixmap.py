...
from Tools.Directories import resolveFilename, fileExists, SCOPE_SKIN_IMAGE, SCOPE_CURRENT_SKIN, SCOPE_ACTIVE_SKIN, SCOPE_ACTIVE_LCDSKIN
from os import path
			...
			for (attrib, value) in self.skinAttributes:
				if attrib == "pixmaps":
					...
					for p in pixmaps:
						...
						elif fileExists(resolveFilename(SCOPE_CURRENT_SKIN, p, path_prefix=skin_path_prefix)):
					...
					if not pixmap:
						...
						elif fileExists(resolveFilename(SCOPE_CURRENT_SKIN, pixmaps[0], path_prefix=skin_path_prefix)):
					...
					elif fileExists(resolveFilename(SCOPE_CURRENT_SKIN, value, path_prefix=skin_path_prefix)):
