...
class LcdSkinSelector(Screen, SkinSelectorBase):
	...
	DEFAULTSKIN = "< Skin modelo A sin picon (default) >"
	PICONSKINXML = "skin_display_picon.xml"
	PICONDEFAULTSKIN = "< Skin modelo B con Picon 100x60 >"
	PICON1SKINXML = "skin_display_picon1.xml"
	PICON1DEFAULTSKIN = "< Skin modelo H con picon A 100x60 >"
	PICON2SKINXML = "skin_display_picon2.xml"
	PICON2DEFAULTSKIN = "< Skin modelo C con Picon 100x60 >"
	PICON3SKINXML = "skin_display_picon3.xml"
	PICON3DEFAULTSKIN = "< Skin modelo D con Picon 100x60 >"
	PICON4SKINXML = "skin_display_picon4.xml"
	PICON4DEFAULTSKIN = "< Skin modelo E con Picon 220x176 >"
	PICON5SKINXML = "skin_display5.xml"
	PICON5DEFAULTSKIN = "< Skin modelo F sin Picon >"
	PICON6SKINXML = "skin_display6.xml"
	PICON6DEFAULTSKIN = "< Skin modelo G con Picon 220x132 >"
