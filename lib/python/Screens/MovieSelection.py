...
config.movielist.root = ConfigSelection(default="/media", choices=["/", "/media", "/media/hdd", "/media/hdd/movie", "/media/usb", "/media/usb/movie", "/media/mmc", "/media/mmc/movie", "/media/uSDextra", "/media/uSDextra/movie"])
