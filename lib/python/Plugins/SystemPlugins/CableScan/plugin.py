...
config.plugins.CableScan.frequency = ConfigFloat(default = [330, 0], limits = [(50, 999),(0, 999)])
...
def getNimList():
	return [x for x in nimmanager.getNimListOfType("DVB-C") if config.Nims[x].dvbc.configMode.value != "nothing"]
