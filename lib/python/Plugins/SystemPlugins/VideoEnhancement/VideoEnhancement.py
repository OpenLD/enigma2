...
class VideoEnhancement():
	...
	def createConfig(self, *args):
		...
		config.pep.configsteps = NoSave(ConfigSelection(choices=[1,
		 5,
		 10,
		 25], default=1))
		...
		if os.path.exists('/proc/stb/vmpeg/0/pep_split'):
			...
			config.pep.split = ConfigSelection(choices={'off': _('Off'),
			 'left': _('Left'),
			 'right': _('Right')}, default='off')
		...
		if os.path.exists('/proc/stb/vmpeg/0/pep_scaler_vertical_dejagging'):
			...
			config.pep.scaler_vertical_dejagging = ConfigBoolean(default=False, descriptions={False: _('Disabled'),
			 True: _('Enabled')})
		...
		if os.path.exists('/proc/stb/vmpeg/0/smooth'):
			...
			config.pep.smooth = ConfigBoolean(default=False, descriptions={False: _('Disabled'),
			 True: _('Enabled')})
