...
class Swap(Screen):
        ...
        def doCSplace(self, name):
                if name:
                        ...
                        myoptions = [[_("64 MB"), '65536'], [_("96 MB"), '98304'], [_("128 MB"), '131072'], [_("256 MB"), '262144'], [_("512 MB"), '524288'], [_("1024 MB"), '1048576'], [_("1256 MB"), '1286144'], [_("1512 MB"), '1548288'], [_("2048 MB"), '2097152']]
