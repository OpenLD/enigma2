...
class SundtekControlCenter(Screen, ConfigListScreen):
	skin = """
		<screen title="SundtekControlCenter" position="center,center" size="570,400" name="SundtekControlCenter">
			...
			<ePixmap position="460, 350" size="100,40" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/LDteam/images/icons/sundtek.png" transparent="1" alphatest="on" />
		</screen>"""
	...
	def disclaimer(self, result): 
		if result:
			self.prompt("/usr/lib/enigma2/python/Plugins/Extensions/LDteam/sundtekinstall.sh")
