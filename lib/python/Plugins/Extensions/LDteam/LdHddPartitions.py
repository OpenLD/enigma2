...
from Plugins.Extensions.LDteam.LdHddMount import HddMount

import os
import sys

def PartitionEntry(description, size):
	picture = LoadPixmap(cached = True, path = resolveFilename(SCOPE_CURRENT_PLUGIN, "/usr/lib/enigma2/python/Plugins/Extensions/LDteam/images/icons/partitionmanager.png"));
