...
class eServiceEvent: public iObject
{
	...
	std::string m_event_name, m_short_description, m_extended_description, m_tmp_extended_description, m_extra_event_data, m_epg_source, m_extended_description_items;
